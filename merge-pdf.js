...
'.mg-big{background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff;font-size:20px;font-weight:800;padding:20px 70px;border-radius:12px;border:none;cursor:pointer;box-shadow:0 14px 34px rgba(79,70,229,.35)}'+
...
'.mg-work{display:flex;min-height:70vh;background:#f2f3f7;border-radius:14px;overflow:hidden}'+
...
'.mg-card{background:#fff;border-radius:10px;box-shadow:0 2px 10px rgba(20,20,60,.08);padding:14px;text-align:center;position:relative;cursor:grab}'+
'.mg-card.drag{opacity:.4}'+
'.mg-card:hover{box-shadow:0 8px 24px rgba(20,20,60,.14)}'+
...
'.mg-addcard:hover{border-color:#4f46e5;color:#4f46e5;background:#eef2ff}'+
'.mg-addcircle{width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff;font-size:26px;border:none;cursor:pointer;box-shadow:0 10px 24px rgba(79,70,229,.4)}'+
'.mg-side{width:330px;background:#fff;border-left:1px solid #e7e8ef;padding:30px 26px;display:flex;flex-direction:column}'+
'.mg-side h2{font-size:26px;font-weight:900;text-align:center;margin-bottom:18px}'+
'.mg-tip{background:#e8f1fd;border-radius:10px;padding:14px 16px;font-size:13.5px;color:#3b5570;line-height:1.55}'+
...
'.mg-bar div{height:100%;width:0;background:linear-gradient(90deg,#4f46e5,#7c3aed);border-radius:999px;transition:width .3s}'+
...
'@media(max-width:900px){.mg-work{flex-direction:column}.mg-side{width:auto;border-left:none;border-top:1px solid #e7e8ef}}'+
'</style>'+
'<div class="mg-wrap">'+
